...
class Contract_method:
    ...
    def insert(self, name, surname, GPAX):
        return self.contract.functions.insertStudent(name, lastname, GPAX).transact({'from': self.owner})
    ...
    def update(self, st_id, name, surname, GPAX):
        return self.contract.functions.updateStudent(st_id, name, lastname, GPAX).transact({'from': self.owner})
